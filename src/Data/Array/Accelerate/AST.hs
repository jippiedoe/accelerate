...
instance HasArraysRepr ArrayVar where
  arraysRepr (Var repr _) = TupRsingle repr

instance HasArraysRepr ArrayVars where
  arraysRepr (VarsSingle var) = arraysRepr var
  arraysRepr VarsNil = TupRunit
  arraysRepr (VarsPair a b) = TupRpair (arraysRepr a) (arraysRepr b)

...
-- module Playground.N2 (program) where
...
instance SliceExt slix sl sh => SliceExt (slix :. All) (sl :. Int) (sh :. Int) where
    indexFull (slix ::. All_) (sl ::. n) = indexFull slix sl ::. n
    indexSlice (slix ::. All_) (sh ::. n) = indexSlice slix sh ::. n
...
program :: Acc ((((), Vector Float), Matrix Float), Matrix Float)
program =
